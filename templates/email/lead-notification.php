  ...
  <tr>
    <td align="center">
      <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="max-width:640px;background:#ffffff;border-radius:10px;overflow:hidden;border:1px solid #e3e6ea;">
        ...
        <tr>
          <td style="background:#0F2E4C;padding:22px 26px;">
            <div style="color:#ffffff;font-size:18px;font-weight:600;letter-spacing:.2px;"><?= $e($company) ?></div>
            <div style="color:#C9A227;font-size:13px;margin-top:4px;">
        ...
        <tr>
          <td style="padding:24px 26px 8px;">
            <h2 style="margin:0 0 14px;font-size:16px;color:#0F2E4C;">Contact information</h2>
            <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="font-size:14px;">
              ...
              <tr><td style="padding:6px 0;color:#67727e;">Phone</td><td style="padding:6px 0;"><a href="tel:<?= $e($lead['phone_normalized'] ?? '') ?>" style="color:#0F2E4C;"><?= $e($phone) ?></a></td></tr>
              ...
              <?php endif; ?>
              <tr><td style="padding:6px 0;color:#67727e;">Email</td><td style="padding:6px 0;"><?= !empty($lead['email']) ? '<a href="mailto:' . $e($lead['email']) . '" style="color:#0F2E4C;">' . $e($lead['email']) . '</a>' : '&mdash;' ?></td></tr>
        ...
        <tr>
          <td style="padding:16px 26px 8px;">
            <h2 style="margin:0 0 12px;font-size:16px;color:#0F2E4C;">Submitted answers</h2>
        ...
        <tr>
          <td style="padding:16px 26px 8px;">
            <h2 style="margin:0 0 12px;font-size:16px;color:#0F2E4C;">Attribution</h2>
        ...
        <tr>
          <td style="padding:20px 26px 26px;">
            ...
            <?php endif; ?>
            <a href="<?= $e($adminUrl) ?>" style="display:inline-block;background:#0F2E4C;color:#ffffff;text-decoration:none;padding:11px 20px;border-radius:6px;font-size:14px;font-weight:600;margin:0 8px 8px 0;">Open in dashboard</a>
          </td>
        </tr>
